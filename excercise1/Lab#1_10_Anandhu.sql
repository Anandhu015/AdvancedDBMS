...
create database company;
use company;
create table jobs(job_id int not null,job_title varchar(100),min_salary varchar(50),max_salary varchar(50),primary key(job_id));
describe jobs;
select * from jobs;
use company;
create table regions(region_id int not null,region_name varchar(200),primary key(region_id));
use company;
create table countries(country_id int not null,country_name varchar(200),region_id int not null,primary key(country_id),foreign key(region_id)references regions(region_id));
use company;
show tables;
create table locations(location_id int not null,street_address varchar(200),postal_code int not null,city varchar(200),state_province varchar(100),country_id int not null,primary key(location_id),foreign key(country_id)references countries(country_id));
use company;
describe locations;
select * from locations;
use company;
create table departments(department_id int not null,department_name varchar(200),primary key(department_id),location_id int not null,foreign key(location_id)references locations(location_id));
show tables;
select * from departments;
drop table employees;
create table employees(employee_id int not null,first_name varchar(200),last_name varchar(200),email varchar(50),phone_number int(10),hire_date date,job_id int not null,salary int,manager_id int not null,department_id int not null,primary key(employee_id),foreign key(department_id)references departments(department_id),foreign key(job_id)references jobs(job_id));
desc employees;
...
desc employees;
create table depedents(dependent_id int not null,first_name varchar(200),last_name varchar(200),relationship varchar(200),employee_id int not null,primary key(dependent_id),foreign key(employee_id)references employees(employee_id)); 
show tables;
...
desc locations;
alter table countries modify country_id varchar(200);
alter table locations modify country_id varchar(200);
...
desc locations;
alter table locations modify column postal_code varchar(100);
select * from locations;
INSERT INTO 
...
select * from jobs;
alter table depaetments rename departments;
...
alter table employees modify column phone_number varchar(200);
desc employees;
alter table employees modify column hire_date varchar(200);
select * from employees; 
...
show tables;
alter table depedents rename dependents;
